  ...
  <div style="padding:.9rem 1rem 1rem;font-size:.76rem;line-height:1.65;color:#333;
    ...
    <div>
      ...
      <p style="margin:0 0 .4rem;">
        Rather than relying on a single election, this benchmark averages five elections across three
        electoral cycles, giving a stable picture of Georgia's underlying partisan geography:
      </p>
    ...
    <div>
      ...
      <dl style="margin:0;display:grid;grid-template-columns:auto 1fr;gap:.2rem .7rem;align-items:baseline;">
        ...
        <dd style="margin:0;">neutral maps generated (draws)</dd>
